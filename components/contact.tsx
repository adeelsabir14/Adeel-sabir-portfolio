...
export default function Contact() {
  ...
  const handleDownloadResume = async () => {
    try {
      ...
      a.href = url
      a.download = "Adeel_Sabir_Resume.txt"
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            I'm always open to new opportunities and collaborations. Whether you have a project in mind, want to discuss
            web development, or just want to connect, feel free to reach out. Let's build something amazing together!
          </p>
        </motion.div>
